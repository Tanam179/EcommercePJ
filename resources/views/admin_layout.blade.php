...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../assets/admincss/morris.css') }}" type="text/css" />
    <!-- calendar -->
    <link rel="stylesheet" href="{{ asset('../assets/admincss/monthly.css') }}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{ asset('../assets/images/adminImg/2.png') }}">
                            <span class="username">Tá Nam</span>
                            <b class="caret"></b>
                        </a>
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© 2022 Visitors. All rights reserved | Designed by <a href="http://w3layouts.com">Tá Nam</a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>

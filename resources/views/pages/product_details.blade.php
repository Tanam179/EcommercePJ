                    ...
                    <div class="product-details-col-72">
                        <div class="product-details-content p-dec-content-edit">
                            ...
                            @if($product_detail->sale == 1)
                                <span style="display: inline-block; margin-top: 32px; margin-bottom: 32px ;font-size: 22px; margin-right: 15px; text-decoration: line-through" class="old-price">{{number_format($product_detail->price , 0 , ',' , ',' )}} VNĐ</span>
                                <span style="display: inline-block; margin-top: 32px; margin-bottom: 32px; font-size: 22px" class="new-price">{{number_format($product_detail->price -  ($product_detail->price * $product_detail->sale_percent / 100))}}VNĐ</span>
                                @else
                                {{-- <span style="font-size: 22px " class="old-price"></span> --}}
                                <span style="display: inline-block; margin-top: 32px; margin-bottom: 32px; font-size: 22px" class="new-price">{{number_format($product_detail->price , 0 , ',' , ',' )}} VNĐ</span>
                                @endif
